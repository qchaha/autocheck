...
public class AutoCheck{
    public static void main(String[] args )
    {
        ...
        String s_awr = "echo 'SET ECHO OFF' > /home/oracle/creawr.sql;" +
                       ...
                       "echo 'cat /home/oracle/awr.txt | sed -n \"${b_num},${e_num}p\"' >> /home/oracle/awr_statistics.sh;" +
                       ...
                       "echo 'cat /home/oracle/awr.txt | sed -n \"${b_num},${e_num}p\" | sed -n \"8,${e2_num}p'\" >> /home/oracle/awr_statistics.sh;" +
