...
public class AutoCheck{
    ...
    {
        String s_cmd = "echo '#!/bin/sh' > test.sh;echo "echo '<tag:date>'" >> test.sh;echo date >> test.sh;echo "echo '<tag:hostname>'" >> test.sh;echo hostname >> test.sh;echo "echo '<tag:uname -a>'" >>test.sh; echo 'uname -a'>>test.sh;sh test.sh";
